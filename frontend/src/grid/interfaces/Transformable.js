...
export class Transformable extends Draggable {
  ...
  fixSizeOnResize() {
    this.transformElement.style.width =
      this.gridSize.x * this.parent.getBlockSize().width + "px";
    this.transformElement.style.top = "0px";
    this.transformElement.style.height =
      this.gridSize.y * this.parent.getBlockSize().height + "px";
    this.transformElement.style.left = "0px";
  }

  fixOriginalSize() {
    this.transformElement.style.width =
      this.originalGridSize.x * this.parent.getBlockSize().width + "px";
    this.transformElement.style.top = "0px";
    this.transformElement.style.height =
      this.originalGridSize.y * this.parent.getBlockSize().height + "px";
    this.transformElement.style.left = "0px";
  }
